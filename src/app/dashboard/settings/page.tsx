                    ...
                    {isAdmin && (
                        <TabsContent value="system" className="space-y-8 animate-in fade-in slide-in-from-bottom-4">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                ...
                                <Card className="glossy-card border-none rounded-[2.5rem] p-10 space-y-8">
                                    <div className="flex items-center gap-4"><Wallet className="text-accent" size={22} /><h2 className="text-xl font-black uppercase italic tracking-tight">CONFIGURATION PI</h2></div>
                                    
                                    <div className="space-y-6">
                                        <div className="space-y-2">
                                            <Label className="text-[10px] font-black uppercase opacity-60">Portefeuille Merchant GCV</Label>
                                            <div className="p-4 bg-background/50 border border-white/5 rounded-2xl flex items-center justify-between group">
                                                <code className="text-[10px] font-mono text-muted-foreground break-all">{PI_MERCHANT_WALLET}</code>
                                                <Button variant="ghost" size="icon" className="shrink-0 opacity-0 group-hover:opacity-100 transition-opacity" asChild>
                                                    <a href={`https://minepi.com/blockexplorer/account/${PI_MERCHANT_WALLET}`} target="_blank" rel="noopener noreferrer"><ExternalLink size={14} /></a>
                                                </Button>
                                            </div>
                                        </div>
                                        ...
                                        <div className="p-4 rounded-2xl bg-orange-500/5 border border-orange-500/20 flex gap-4">
                                            ...
                                            <div className="space-y-1">
                                                <p className="text-[10px] font-black uppercase text-orange-500">Mode Sandbox Actif</p>
                                                <p className="text-[9px] text-muted-foreground leading-tight">Les fonds affichés ici proviennent du réseau de test Pi.</p>
                                            </div>
                                        </div>

                                        <div className="pt-4 border-t border-white/5 flex justify-between items-center">
                                            <span className="text-[10px] font-bold uppercase text-muted-foreground">Valeur Consensus</span>
                                            <Badge className="bg-accent/20 text-accent font-black border-none uppercase text-[10px]">1 π = $314,159</Badge>
                                        </div>
                                    </div>
                                </Card>
                            </div>

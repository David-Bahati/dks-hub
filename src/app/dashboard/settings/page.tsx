                    ...
                    <TabsContent value="profile" className="space-y-10 animate-in fade-in slide-in-from-bottom-4">
                        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
                            ...
                            <div className="lg:col-span-2 space-y-6">
                                ...
                                <Card className="bg-white/5 border border-white/5 rounded-[2.5rem] p-8 flex items-center justify-between">
                                    <div className="flex items-center gap-6">
                                        <div className="w-14 h-14 rounded-2xl bg-white/5 flex items-center justify-center">
                                            <Smartphone size={28} className="text-muted-foreground" />
                                        </div>
                                        <div>
                                            <h4 className="font-black uppercase italic text-sm">COMPTE SOCIAL LIÉ</h4>
                                            <p className="text-[10px] text-muted-foreground font-medium uppercase tracking-widest">Connectez-vous plus vite avec GitHub</p>
                                        </div>
                                    </div>
                                    <Button variant="outline" className="rounded-xl border-white/10 font-bold uppercase italic text-[10px] h-11 px-6 gap-2">
                                        <Github size={14} /> LIÉ
                                    </Button>
                                </Card>
                            </div>
